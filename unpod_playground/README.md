...
uv run python -m unpod_playground.run
```
...
```bash
uv run python -m unpod_playground.run       # terminal 1 — harness :9100
cd unpod_playground/web && npm run dev      # terminal 2 — Vite :5173
```
